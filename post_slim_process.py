...
print("start recapitating at " + datetime.now())
...
print("recapitation completed. Adding neutral mutations at " + datetime.now())
...
print("neutral mutations added. Start running forward-in-time sims post SLiM at " + datetime.now())
...
print("msprime sim ancestry done. now adding mutations to the new ts at " + datetime.now())
...
print("There are {len(new_nodes)} nodes from the start of the new simulation. Current time: " + datetime.now())

slim_nodes = rts.samples(time=0)

print("nodes sampled from the original ts at " + datetime.now())
...
print("merging tables at " + datetime.now())
